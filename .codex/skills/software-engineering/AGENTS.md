...
> Auto-generated from `.claude/skills/software-engineering/SKILL.md`.
...
- This context is for the `software-engineering` skill only.
- It should augment the base repo `AGENTS.md`, not replace it.
- Prefer loading this file through `./codex-skill software-engineering` or by explicitly asking Codex to read `.codex/skills/software-engineering/AGENTS.md`.
