...
> Auto-generated from `.claude/skills/quaks-generator/SKILL.md`.
...
- This context is for the `quaks-generator` skill only.
- It should augment the base repo `AGENTS.md`, not replace it.
- Prefer loading this file through `./codex-skill quaks-generator` or by explicitly asking Codex to read `.codex/skills/quaks-generator/AGENTS.md`.
