...
> Auto-generated from `.claude/skills/quant/SKILL.md`.
...
- This context is for the `quant` skill only.
- It should augment the base repo `AGENTS.md`, not replace it.
- Prefer loading this file through `./codex-skill quant` or by explicitly asking Codex to read `.codex/skills/quant/AGENTS.md`.
